...
// @exclude      /^(?!https:\/\/yukkuri\.shiteitte\.net\/((posts|upload_media_assets|uploads)\/\d+|uploads\/\d+\/assets\/\d+|settings)\/?(\?|$)).*/
// @exclude      /^https://yukkuri\.shiteitte\.net/.*\.(xml|json|atom)(\?|$)/
// @run-at       document-idle
// @downloadURL  https://raw.githubusercontent.com/CommentaryRequest/OYPJavaScripts/master/IndexedRelatedTags.user.js
// @updateURL    https://raw.githubusercontent.com/CommentaryRequest/OYPJavaScripts/master/IndexedRelatedTags.user.js
